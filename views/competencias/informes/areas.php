...
$filtros = "";
if ($_POST["fill_area"]) {
    $filtros .= " AND id_area = '" . $_POST["fill_area"] . "' ";
}
...
//DATOS PROCESADOS
//DATOS PROCESADOS
$array_areas_resumen = array();

foreach ($array_areas_l as $gerencia) {
    if ($gerencia > 0) {
        $queryAre = mysqli_query($connect_valentina, "SELECT * FROM Areas WHERE id = '" . $gerencia . "' ");
        $dataAre = mysqli_fetch_array($queryAre);

        $promedio_gerencia = 0;
        $counts_gerencia = 0;
        foreach ($array_evaluaciones_general as $evals) {
            if ($evals["id_area"] == $gerencia) {
        ...
        array_push($array_areas_resumen, $nodo);
    }
}

foreach ($array_areas_resumen as $key => $row) {
    $aux[$key] = $row['promedio'];
}
array_multisort($aux, SORT_DESC, $array_areas_resumen);
        ...
        <div class="col-12">
            <div class="card mb-3">
                <div class="card-header">
                    <h3>
                        Informes Áreas <?= $dataCicloVal["anio"]; ?> | <small>Ciclo: <?php echo $dataCicloVal["nombre"]; ?></small>
            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-pills justify-content-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="?pg=competencias/informes/areas">Áreas</a>
                        </li>
                        <li class="nav-item">
...
<div class="container-fluid" style="max-width: 90%; margin: 0 auto;">
    ...
    <div class="row">
            ...
            <form action="" method="post">
                <div class="row">
                    ...
                    <div class="col-md-9 mb-3">
                        ...
                        <select class="form-control multiples_responsables" name="fill_area">
                            <option value="">Filtrar por Procesos...</option>
                            <?php
                            foreach ($array_areas_Filtro  as $gerencia) {

                                if ($gerencia > 0) {
                                    $queryG = mysqli_query($connect_admin, "SELECT * FROM Areas WHERE id = '" . $gerencia . "' ");
        ...
        <div class="col-md-3 text-center">
            <div class="card fichas">
                <div class="card-body">
                    <div class="ti_ficha">Procesos</div>
        ...
        <div class="col-md-12">
            <div class="card fichas">
                ...
                <div class="card-body">
                    ...
                    <?php
                    foreach ($array_areas_resumen as $gerencia) {
                    ?>
                        <div class="mt-1">
