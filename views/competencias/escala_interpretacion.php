...
if ($_POST["nombre_n_1"] != "") {
	...
	if ($_POST["id_registro"] != "") {
		$ClassCompetenciasCrud->Editar_Escala_Interpretacion($_POST);
	} else {
		$ClassCompetenciasCrud->Guardar_Escala_Interpretacion($user_log["id_empresa"], $_SESSION["anio_ciclo"], $_POST);
	}

	/* echo '
            <script> window.location = "' . $url . '/?pg=competencias_pc/escala_interpretacion"; </script>
        '; */
}

$data = $ClassCompetencias->Obtener_Escala_Interpretacion($user_log["id_empresa"], $_SESSION["anio_ciclo"]); //DATOS DE LA ESCALA DE INTERPRETACION
?>
			...
			<div class="card">
				<div class="card-header">
					<ul class="nav nav-pills justify-content-center">
						...
						<li class="nav-item">
							<a class="nav-link active" href="?pg=competencias/escala_interpretacion">Interpretación</a>
						</li>
						<li class="nav-item">
						...
						<div class="col-md-12">
							<form action="" method="post">
								...
								<table width="100%">
									...
									<tr>
										<td width="16%" bgcolor="#FF0000" align="center" style="font-size: 25px; padding: 20px; font-weight: bold">
											
										</td>
										<td width="16%" bgcolor=" #FFF200" align="center" style="font-size: 25px; padding: 20px; font-weight: bold">
											
										</td>
										<td width="16%" bgcolor=" #95FA03" align="center" style="font-size: 25px; padding: 20px; font-weight: bold">
											
										</td>
										<td width="16%" bgcolor=" #14F209" align="center" style="font-size: 25px; padding: 20px; font-weight: bold">
											
										</td>
										<td width="16%" bgcolor=" #00D30A" align="center" style="font-size: 25px; padding: 20px; font-weight: bold">
									...
									<tr>
										<td>
											...
											<input type="text" class="form-control titu" placeholder="Ingresar rango..." name="rango_1" value="<?php echo $data["rango_1"]; ?>">
										</td>
										<td>
											...
											<input type="text" class="form-control titu" placeholder="Ingresar rango..." name="rango_2" value="<?php echo $data["rango_2"]; ?>">
										</td>
										<td>
											...
											<input type="text" class="form-control titu" placeholder="Ingresar rango..." name="rango_3" value="<?php echo $data["rango_3"]; ?>">
										</td>
										<td>
											...
											<input type="text" class="form-control titu" placeholder="Ingresar rango..." name="rango_4" value="<?php echo $data["rango_4"]; ?>">
										</td>
										<td>
											...
											<input type="text" class="form-control titu" placeholder="Ingresar rango..." name="rango_5" value="<?php echo $data["rango_5"]; ?>">
										</td>
									</tr>
								</table>
