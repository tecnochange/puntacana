...
foreach($vicepresidencias_listas as $vicepresidencia){
    echo "<h3>".$vicepresidencia["nombre"]."</h3>";
    echo "<br>";

    foreach($vicepresidencia["areas"] as $area){

        echo $area["area_nombre"]." - ".$area["avance_area"]." - ".$area["kpis_cantidad"];
        echo "<br>";
    }
    echo "<hr>";
    //
...
//$vicepresidencias = $ClassKpisServicios->Vicepresidencias($user_log["id_empresa"]);
				    ...
				    <div class="card-body" style="padding: 5px 20px;" >
							<div class="row">
								...
								<div class="col-md-2 d-flex align-items-center">
									<div class="text-left" style="width: 100%;">
                                        ...
                                        foreach($vicepresidencia["array_lideres"] as $lider){
                                            if($lider["id"]){
                                                $min_lider .= '
                                                <img src="'.$recursos_local . $lider["foto"].'"
                                                    width="32" height="32"
								...
								<div class="col-md-2 d-flex align-items-center justify-content-center">
									Kpis Asignados <span class="px-1"><b><?= $vicepresidencia["kpis_asignados"]; ?></b></span>
								</div>
								...
								<div class="col-md-1 d-flex align-items-center justify-content-center">
									<a href="<?php echo $url; ?>?pg=kpis/consolidado/vicepresidencias&id=<?= $vicepresidencia["id"]; ?>">
                                            ...
                                            <?php
                                                foreach($vicepresidencia["areas_lista"] as $area){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>'.$area["kpis_cantidad"].'</td>
                                                        <td>

                                                            <div class="progress">
                                                                <div class="progress-bar bg-success" role="progressbar" style="width: '.$area["avance_area"].'%; background-color:'.$area["avance_color"].' !important;" aria-valuenow="'.$area["avance_area"].'" aria-valuemin="0" aria-valuemax="100"></div>
                                                            </div>
                                                            <b>'.$area["avance_area"].'%</b>
                                                            
                                                        </td>
                                                        <td></td>
                                                        <td>
                                                            <a href="#&id_area_proceso='.$area["area_proceso"].'">
																<i class="bi bi-eye-fill fs-4"></i>
															</a>
                                                        </td>
                                                    </tr>
