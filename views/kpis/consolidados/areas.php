...
$array_kpis_general = $ClassKpisServicios->kpis_area($user_log["id_empresa"], $id_area, NULL);
$array_kpis_general_paginado = $ClassKpisServicios->kpis_area_paginado($user_log["id_empresa"], $id_area, NULL, $posicion, $longitud );
...
echo "Total paginado ".$total_paginado;
echo "Total paginas ".$total_pagina; */
...
<div class="container-fluid pb-2">
	...
	<div class="card mb-3">
		<div class="card-header">
			<h3>Consolidado del año <?php echo $_SESSION["anio_fill"]; ?> para el área: <?php echo $data["nombre"]; ?></h3>
		</div>
	</div>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                for ($x = 0; $x < $total_pagina; $x++) {
                    if($x == $_GET["p"]){
                        echo '<li class="page-item active"><a class="page-link" href="?pg=kpis/consolidados/areas&id='.$id_area.'&p='.$x.'">'.($x+1).'</a></li>';
                    }
                    else{
                        echo '<li class="page-item"><a class="page-link" href="?pg=kpis/consolidados/areas&id='.$id_area.'&p='.$x.'">'.($x+1).'</a></li>';
                    }
                }
                ?>
