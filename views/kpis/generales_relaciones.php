...
$vicepresidencias_listas = $ClassKpisServicios->vicepresidencias_lista_relaciones($user_log["id_empresa"], $array_vicepresidencia);
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td><?php echo $area["kpis_cantidad"]; ?></td>
													<td>
														<div class="progress">
															...
															<div class="p-3">
																...
																<table class="table table-sm table-bordered mb-0">
																	...
																	<tbody>
																		...
																		<!-- EJEMPLO (Se debe llenar dinámicamente) -->
																		<!-- <tr>
																			<td>Subproceso 1</td>
