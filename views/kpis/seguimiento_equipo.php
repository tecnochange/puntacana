                        ...
                        <?php foreach($Kpis_seguimiento_equipo as $kpis): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    Progreso
                                    <div class="progress">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: <?= $kpis["progreso"]; ?>%; background-color:<?= EscalaColor($kpis["progreso"]); ?> !important;" aria-valuenow="<?= $kpis["progreso"]; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <b><?= number_format($kpis["progreso"], 0); ?>%</b> 
                                </td>
                                <td class="text-center">
