        ...
        <div class="card-body">
            ...
            <form method="POST">
                ...
                <div class="row">
                    ...
                    <div id="altadireccionSelect" class="col-md-4 mb-2 d-none">
                    ...
                    <div id="areaSelect" class="col-md-4 mb-2 d-none">
                        <label><strong>Área *</strong></label>
                        <select class="multiples_responsables form-control" id="area" name="area" disabled onchange="ColaboradoresArea()">
                            <option value="">Seleccione...</option>
                        </select>
                    </div>
                </div>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">
                                    Colaborador
                                    <input type="checkbox" onclick="SeleccionarTodos(this, 3);">
                                </th>

                                <th class="text-center">
                                    Líder
                                    <input type="checkbox" onclick="SeleccionarTodos(this, 2);">
                                </th>
                            </tr>
                        </thead>
                        <tbody></tbody>
...
/*
    function SeleccionarTodos(element, tipo) {
        ...
        $('input.chk-rol', filas).prop('checked', false);
...
<script>
    ...
    const ValidarContribucion = (contribucion) => {
        if (!contribucion) {
...
<script>
    function ColaboradoresArea() {
        vicepresidencia = $("#vicepresidencia").val();
        area = $("#area").val();
        
        $.ajax({
                url: api + "lista_colaboradores_area.php",
                type: "POST",
                data: {
                    id_empresa: <?php echo $user_log["id_empresa"]; ?>,
