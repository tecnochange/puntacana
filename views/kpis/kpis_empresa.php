...
$array_kpis_general_paginado = $ClassKpisServicios->kpis_empresa_paginado($user_log["id_empresa"], $posicion, $longitud);
...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <h3>Todos los KPIs de la Compañía para el año <?php echo $_SESSION["anio_fill"]; ?></h3>
        </div>
    </div>
    ...
    <div class="card mb-3">
        ...
        <div class="accordion accordion-flush p-3" id="accordionVicepresidencias">
            ...
            <?php
            foreach ($array_kpis_general_paginado as $kpis) {
...
<?php include("views/kpis/componentes/modal_accion_correctiva.php"); ?>
