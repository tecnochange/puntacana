...
$queryEmploy = mysqli_query($connect_valentina, "SELECT * FROM Empleados WHERE id = '" . $_SESSION['id_user'] . "' ");
$dataEmploy = mysqli_fetch_array($queryEmploy);

//CONSULTAMOS LAS PUBLICACIONES
$query = mysqli_query($connect_clima, "SELECT * FROM Publicaciones WHERE id_empresa = '" . $_SESSION["id_empresa"] . "' AND estado = 1 AND fecha_publicacion <= '" . $ahora . "' " . $filtro . " ORDER BY id DESC LIMIT 20 ");
...
$querySM51 = mysqli_query($connect_valentina, "SELECT * FROM Submenu_Empresa WHERE id_empresa = " . $_SESSION["id_empresa"] . " AND estado = 1 AND id_menu = 5 AND id_submenu = 31");
            ...
            <div class="card-header" style="background-color: #FFFFFF !important;">
                <div class="row">
                    <div class="col-md-12" style="text-align: start !important;">
                        <h4><i class="fas fa-bullhorn" id="iconCabecera"></i>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo $dataSM51["nombre"]; ?></h4>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid">
    <div class="row justify-content-md-center">
            ...
            <div class="card">
                <div class="card-body">
                    <a href="<?php echo $url; ?>?pg=endomarketing/muro">
                        <div align="center">
                            <i class="fas fa-grip-horizontal iconos_dash" style="color: #365189;"></i><br>
        ...
        while ($data = mysqli_fetch_array($query)) {
            ...
            $queryUser = mysqli_query($connect_valentina, "SELECT * FROM Empleados WHERE id = '" . $data["id_user"] . "' ");
        ...
        <?php if (!$_GET["all"]) { ?>
            <a href="<?php echo $url; ?>?pg=endomarketing/muro&all=21">
    ...
    <!-- FIN MURO 
        pregunta 1 opción de respuesta  3
        -->
