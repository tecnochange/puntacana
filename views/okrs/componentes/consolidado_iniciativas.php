        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12 d-flex align-items-center pt-3" style="text-align: center;text-align: -webkit-center;">
                <div class="row circular-chart-component">
                    <div class="easy-pie-chart" data-percent="<?php echo $datos_consolidado_iniciativas["promedio_general"]; ?>">
                        <div class="okr-progress-value">
                            <?php echo $datos_consolidado_iniciativas["promedio_general"]; ?>%
                        </div>
                    </div>
                    <p class="progress-label"> <b>Avance total de Iniciativas</b> </p>
                </div>
            </div>

            <div class="col-md-8 col-12 pt-3 text-center">
                <b>Consolidado de progreso por iniciativas</b>
                <?php 
                // Ejemplo de datos desde PHP - reemplaza por tus consultas
                $mediciones = [
                    [$datos_consolidado_iniciativas["titulo_1"] , $datos_consolidado_iniciativas["cantidad_1"], $datos_consolidado_iniciativas["color_1"] ],
                    [$datos_consolidado_iniciativas["titulo_2"] , $datos_consolidado_iniciativas["cantidad_2"], $datos_consolidado_iniciativas["color_2"] ],
                    [$datos_consolidado_iniciativas["titulo_3"] , $datos_consolidado_iniciativas["cantidad_3"], $datos_consolidado_iniciativas["color_3"] ],
                    [$datos_consolidado_iniciativas["titulo_4"] , $datos_consolidado_iniciativas["cantidad_4"], $datos_consolidado_iniciativas["color_4"] ],
                    [$datos_consolidado_iniciativas["titulo_5"] , $datos_consolidado_iniciativas["cantidad_5"], $datos_consolidado_iniciativas["color_5"]]
                ];
...
<script>
    $(document).ready(function() {
        $('.easy-pie-chart').easyPieChart({
            ...
            barColor: '#8bc34a', // Color de la parte llena (verde)
