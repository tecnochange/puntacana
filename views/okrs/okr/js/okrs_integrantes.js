        ...
        lista.forEach(function (empleado) {
            ...
            $tbody.append(`
                <tr>
                    ...
                    <td align="center"><input type="checkbox" name="empleados[${empleado.id}][admin_kr]" value="1"></td>
                    <td align="center"><input type="checkbox" name="empleados[${empleado.id}][contrib_dir]" value="1"></td>
                    <td align="center"><input type="checkbox" name="empleados[${empleado.id}][contrib_ap]" value="1"></td>
                </tr>
            `);
        });
    }
...
$(document).on("change", "#tablaEmpleados input[type='checkbox']", function () {
    ...
    if (!seleccionados[empleadoId]) {
        seleccionados[empleadoId] = { admin_kr: 0, contrib_dir: 0, contrib_ap: 0 };
    }
