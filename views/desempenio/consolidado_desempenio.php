...
$array_colaboradores = $ClassColaboradores->colaboradores_lista(NULL, $connect_valentina);

$filtros = " AND anio =  '".$_SESSION["periodo_desempenio_fill"]."' ";

if($_POST["periodo_fill"]){
    $filtros = " AND anio = '".$_POST["periodo_fill"]."' "; ;
}
...
<div class="container-fluid">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 mb-3">
					...
					<select class="form-control form-control-sm" name="periodo_fill">
                ...
                <div class="col-md-3 mb-3">
                    <select class="form-control form-control-sm" name="vicepresidencia_fill">
								...
								<?php
                                $queryVice = mysqli_query( $connect_valentina, "SELECT id, nombre FROM Vicepresidencia WHERE estado = 1 AND id_empresa = '".$_SESSION["id_empresa"]."' ORDER BY nombre ASC");
                ...
                <div class="col-md-3 mb-3">
                    <select class="form-control form-control-sm" name="area_fill">
								...
								<?php
                                $queryArea = mysqli_query( $connect_valentina, "SELECT id, nombre FROM Areas WHERE estado = 1 AND id_empresa = '".$_SESSION["id_empresa"]."' ORDER BY nombre ASC");
                ...
                <div class="col-md-3 mb-3">
                    <select class="form-control form-control-sm" name="unidad_fill">
								...
								<?php
                                $queryArea = mysqli_query( $connect_valentina, "SELECT id, unidad_organizativa FROM Estructura_Empresa WHERE estado = 1 AND id_empresa = '".$_SESSION["id_empresa"]."' AND unidad_organizativa != '' ORDER BY unidad_organizativa ASC");
		                        while($dataArea = mysqli_fetch_array($queryArea)){
                ...
                <div class="col-md-3 mb-3">
                    <select class="form-control form-control-sm" name="nivel_fill">
								...
								<?php
                                $queryArea = mysqli_query( $connect_valentina, "SELECT id, nombre FROM Nivel_Jerarquico WHERE estado = 1 AND id_empresa = '".$_SESSION["id_empresa"]."' ORDER BY nombre ASC");
		                        while($dataArea = mysqli_fetch_array($queryArea)){
                ...
                <div class="col-md-3 mb-3">
                    <select class="form-control form-control-sm" name="cargo_fill">
								...
								<?php
                                $queryCargos = mysqli_query( $connect_valentina, "SELECT id, nombre FROM Cargos WHERE estado = 1 AND id_empresa = '".$_SESSION["id_empresa"]."' ORDER BY nombre ASC");
                ...
                <div class="col-md-3 mb-3">
                    <button type="submit" class="btn btn-primary">Filtrar</button>
                            <a href="?pg=desempenio_individual/sincronizar">
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3><i class="fas fa-tasks" id="iconCabecera"></i> Consolidado Desempeño  </h3>
        </div>
