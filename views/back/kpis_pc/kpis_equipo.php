...
if ($_GET["id_user"] != "") {
    $_SESSION["colaborador_fill"] = $_GET["id_user"];
}

if ($_POST["colaborador_fill"] != "") {
    $_SESSION["colaborador_fill"] = $_POST["colaborador_fill"];
}
if ($_POST["colaborador_fill"] == -1) {
    $_SESSION["colaborador_fill"] = "";
}
if ($_SESSION["colaborador_fill"] > 0) {
    $filtro .= " AND KC.id_colaborador = '" . $_SESSION["colaborador_fill"] . "'  ";
}
...
if ($_POST["filtro_kpis"] != "") {
    echo '<script> window.location.href = "?pg=kpis_pc/kpis_equipo&page=1";</script>';
}
...
if ($_POST["guardar_semestral"] != "") {
    ...
    echo '<script> window.location.href = "?pg=kpis_pc/kpis_equipo&kpi_=' . $_POST["id_kpi"] . '' . $pagina . '";</script>';
}
...
$querySM66 = mysqli_query($connect_valentina, "SELECT * FROM Submenu_Empresa WHERE id_empresa = " . $_SESSION["id_empresa"] . " AND estado = 1 AND id_menu = 6 AND id_submenu = 38");
$dataSM66 = mysqli_fetch_array($querySM66);
...
<script>
    ...
    $("#bt_kpi_equipo").addClass("current-page");
</script>
            ...
            <div class="card-header" style="background-color: #FFFFFF !important;">
                <div class="row">
                    <div class="col-md-12" style="text-align: start !important;">
                        <h4 style="font-family: Lato-Black !important;color: #365189 !important;font-size: 1.5rem !important;"><i class="fas fa-chart-line" id="iconCabecera"></i>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo $dataSM66["nombre"]; ?></h4>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <?php include("views/kpis_pc/detalle/filtro_kpis_equipo.php"); ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div id="accordionIconsKpis" class="accordion-icons" role="tablist">
                    <?php
                    // $complemento = "AND KC.area_proceso IN (" . $_SESSION["area"] . ")";
                    ...
                    if (mysqli_num_rows($queryLV) > 0) {
                        ...
                        $complemento = "AND KC.area_macro IN ($listadoLV)";
                    } else {
                        ...
                        if (mysqli_num_rows($queryLA) > 0) {
                            ...
                            $complemento = "AND KC.area_proceso IN ($listadoLA)";
                        }
                    }

                    $queryKpis = mysqli_query($connect_kpis, "SELECT DISTINCT(K.Id) AS id, K.tipo_kpi, K.anio, K.area_macro, K.area_proceso, K.subproceso, K.objetivo_sg, K.indicador, K.objetivo_indicador,
                    ...
                    $queryKpisP = mysqli_query($connect_kpis, "SELECT DISTINCT(K.Id) AS id, K.tipo_kpi, K.anio, K.area_macro, K.area_proceso, K.subproceso, K.objetivo_sg, K.indicador, K.objetivo_indicador,
                    K.formula, K.resultado_anterior, K.unidad_medida, K.tipo_calculo, K.meta, K.frecuencia, K.tipo_resultado, K.obj_meses $mesConsultaI $mesConsultaF $periodoFill
                    FROM Kpis K
                    INNER JOIN Kpis_Colaborador KC ON KC.id_kpi = K.id
                    INNER JOIN Frecuencia_Kpis FKP ON FKP.id_kpi = K.id
                    WHERE K.id_empresa = " . $_SESSION['id_empresa'] . " AND K.anio = " . $_SESSION['anio_fill'] . " $complemento $filtro ORDER BY K.indicador ASC LIMIT $inicio, $registros_por_pagina");
                    $total_paginas = ceil($total_registros / $registros_por_pagina);
                    // echo mysqli_num_rows($queryKpis);
                    ...
                    $sumSeguimiento = $sumAvance = $contKpi = $sumAvanceE = $contKpiE = $contKpiT = $contKpiE = $sumAvanceE = $sumAvanceT = 0;
                    ...
                    while ($dataKpis = mysqli_fetch_array($queryKpisP)) {
                        ...
                        while ($dataKpisC = mysqli_fetch_array($queryKpisC)) {
                            ...
                            $colaborador = mysqli_query($connect_valentina, "SELECT * FROM Empleados WHERE id = '" . $dataKpisC['id_colaborador'] . "' ");
                        ...
                        $frecuencia = mysqli_query($connect_kpis, "SELECT $queryFrecuencia  FROM Frecuencia_Kpis FKP WHERE FKP.id = " . $dataKpis['obj_meses'] . "$filtroKpi ");
                        ...
                        <div class="card mb-0" style="margin-bottom: 10px !important;">
                            <div class="card-header" role="tab" id="heading<?php echo $dataKpis["id"]; ?>">
                                <div class="row" style="align-items: center;">
                                    <div class="col-md-5">
                                        <h5 style="color: #888888 !important;"><?php echo $etiquetaKpiTK; ?>: &nbsp; <?php foreach ($Array_tipo_kpi_PC1 as $tipoKpi) {
                                                                                                                            if ($dataKpis["tipo_kpi"] ==  $tipoKpi[0]) {
                                                                                                                                echo $tipoKpi[1];
                                                                                                                            }
                                                                                                                        } ?></h5>
                                        ...
                                        <h5 style="color: #888888 !important;"><?php echo $etiquetaKpiAM; ?>: &nbsp; <?php $queryAM = mysqli_query($connect_valentina, "SELECT * FROM Vicepresidencia WHERE id = '" . $dataKpis["area_macro"] . "' ");
                                                                                                                        $dataAM = mysqli_fetch_array($queryAM);
                                                                                                                        echo  $dataAM["nombre"]; ?></h5>
                                        <h5 style="color: #888888 !important;"><?php echo $etiquetaKpiAP; ?>: <?php $queryAP = mysqli_query($connect_valentina, "SELECT * FROM Areas WHERE id = '" . $dataKpis["area_proceso"] . "' ");
                                                                                                                $dataAP = mysqli_fetch_array($queryAP);
                                                                                                                echo  $dataAP["nombre"]; ?></h5>
                                        <h5 style="color: #888888 !important;"><?php echo $etiquetaKpiSP; ?>: <?php $queryEE = mysqli_query($connect_valentina, "SELECT * FROM Estructura_Empresa WHERE vicepresidencia = '" . $dataKpis["area_macro"] . "' AND area = '" . $dataKpis["area_proceso"] . "' ");
                                    ...
                                    <div class="col-md-1">
                                        <div class="row" style="align-items: center;">
                                            <?php
                                            include("views/kpis_pc/permisos_rol.php");
                                            if ($_SESSION['role_plataforma'] == 1 || $permisoEditKPI == true || $permisoMetaKPI == true) { ?>
                                                <div class="col-md-9" style="text-align:end;">
                                                    <button type="button" class="btn btn-outline-dark btn-sm bt_editar" data-bs-toggle="tooltip" title="Editar KPI" onclick="location.href='<?php echo $url; ?>?pg=kpis_pc/detalle/editar&id_kpi=<?php echo $dataKpis['id']; ?>&id_frecuencia=<?php echo $dataKpis['obj_meses']; ?>&page=<?php echo $_GET['page']; ?>&menu=kpis_equipo'">
                                                        <i class="fas fa-edit" style="font-size: 15px !important;"></i>
                                                    </button>

                                                    <?php if ($_SESSION['role_plataforma'] == 1 || $permisoEditIntegrantes == true) { ?>
                                                        <button type="button" class="btn btn-outline-dark btn-sm bt_editar" data-bs-toggle="tooltip" title="Editar KPI" onclick="location.href='<?php echo $url; ?>?pg=kpis_pc/detalle/asignar_colaborador_lider&id_kpi=<?php echo $dataKpis['id']; ?>&id_frecuencia=<?php echo $dataKpis['obj_meses']; ?>&page=<?php echo $_GET['page']; ?>&menu=kpis_equipo'">
                                                            <i class="fas fa-user-plus" style="font-size: 15px !important;"></i>
                                                        </button>
                                                    <?php } ?>
                                                </div>
                                            ...
                                            <?php } else if ($_SESSION['role_plataforma'] == 1 || $permisoEditIntegrantes == true) { ?>
                                                <div class="col-md-9" style="text-align:end;">
                                                    <button type="button" class="btn btn-outline-dark btn-sm bt_editar" data-bs-toggle="tooltip" title="Editar KPI" onclick="location.href='<?php echo $url; ?>?pg=kpis_pc/detalle/asignar_colaborador_lider&id_kpi=<?php echo $dataKpis['id']; ?>&id_frecuencia=<?php echo $dataKpis['obj_meses']; ?>&page=<?php echo $_GET['page']; ?>&menu=kpis_equipo'">
                                                        <i class="fas fa-user-plus" style="font-size: 15px !important;"></i>
                                                    </button>
                    ...
                    include("views/kpis_pc/desempenio_kpis_equipo.php");
    ...
    <div class="row">
        <div class="col-md-12 table-responsive">
            ...
            if ($page > 1) {
                echo '<li class="page-item"><a class="page-link" href="?pg=kpis_pc/kpis_equipo&page=' . ($page - 1) . '">Anterior</a></li>';
            }

            // Enlaces numéricos
            for ($i = 1; $i <= $total_paginas; $i++) {
                $activo = ($i == $page) ? 'active' : '';
                echo '<li class="page-item ' . $activo . '"><a class="page-link" href="?pg=kpis_pc/kpis_equipo&page=' . $i . '">' . $i . '</a></li>';
            }

            // Enlace a la página siguiente
            if ($page < $total_paginas) {
                echo '<li class="page-item"><a class="page-link" href="?pg=kpis_pc/kpis_equipo&page=' . ($page + 1) . '">Siguiente</a></li>';
            }
...
<script>
    <?php if ($_GET["id_user"] != "") { ?>removeUrlParameter('id_user');
    <?php    } ?>
    ...
    function GuardarAvances(id) {
        window.location = "?pg=kpis_pc/kpis_equipo&kpi_=" + id;
    }
