<script>
    ...
    $("#bt_okrs_crear").addClass("current-page");
</script>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-12">
                        <h4><i class="fas fa-bullseye" id="iconCabecera"></i>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo $dataSM81["nombre"]; ?></h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12" align="center">
            ...
            <div class="card" style="margin-bottom: 15px">
                ...
                <div class="card-body">
                    ...
                    <!-- <h3>Ficha <?php //echo $etiquetaOkr; ?></h3> -->
                    ...
                    <form action="" method="post">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <label><?php echo $etiquetaOkrTO; ?> *</label>
                                ...
                                <div class="col-md-2" id="anioOkrSelect1">
                                    <label>* Año</label>
                                    <select class="form-control" name="anio1" id="anio1" onchange="select_estrategico(this);">
                                        <option value="">Selecciona...</option>
                                        <?php
                                ...
                                <div class="col-md-4" id="vicepresidencia">
                                    <label><?php echo $etiquetaOkrAD; ?></label>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <label><?php echo $etiquetaOkrP; ?> *</label>
                                ...
                                <div class="col-md-4">
                                    <label><?php echo $etiquetaOkrOW; ?> *</label>
