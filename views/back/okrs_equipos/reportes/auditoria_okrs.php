<script>
    $(document).ready(function() {
        ...
        $("#bt_okrs_aucitoria").addClass("current-page");
    });
</script>
<?php
$querySM101 = mysqli_query($connect_valentina, "SELECT * FROM Submenu_Empresa WHERE id_empresa = " . $_SESSION["id_empresa"] . " AND estado = 1 AND id_menu = 10 AND id_submenu = 57");
$dataSM101 = mysqli_fetch_array($querySM101);
?>
<style>
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-12">
						<h3><i class="fas fa-tasks" id="iconCabecera"></i>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo mb_strtoupper($dataSM101["nombre"]); ?></h3>
					</div>
				</div>
			</div>
		</div>
                    ...
                    <div class="card-body">
                        <table border="1" id="auditoria" class="display table" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $count = 1;
                                $query = mysqli_query($connect_okrs, "SELECT * FROM Auditoria_Okrs WHERE id_empresa = " . $_SESSION["id_empresa"] . " LIMIT 100 ");
