<script>
    $(document).ready(function() {
        // $("#bt_estructura_lideres").addClass("active");
        // $("#nav_empresa").addClass("menu-is-opening menu-open");
        // $("#mod_estructura").addClass("active_qa");
...
$querySM48 = mysqli_query($connect_valentina, "SELECT * FROM Submenu_Empresa WHERE id_empresa = " . $_SESSION["id_empresa"] . " AND estado = 1 AND id_menu = 4 AND id_submenu = 27");
$dataSM48 = mysqli_fetch_array($querySM48);
?>
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header" style="background-color: #FFFFFF !important;">
                <div class="row">
                    <div class="col-md-12" style="text-align: start !important;">
                        <h4><i class="fas fa-dice-d20" id="iconCabecera"></i>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo $dataSM48["nombre"]; ?></h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <div class="card">
                        ...
                        <table border="1" id="lideres" class="display table" style="width:100%;">
                            <thead class="">
                                <tr>
                                    ...
                                    <th scope="col" colspan="7">Jefes Asignados</th>
                                </tr>
                                <tr>
                                    <th scope="col">#</th>
                    ...
                    SELECT e.id, e.documento, e.nombre, c.nombre as nombre_cargo, a.nombre as nombre_area
					FROM Empleados e
                        LEFT JOIN Posiciones p ON p.id = e.id_posicion
                        LEFT JOIN Cargos c ON c.id = e.id_cargo
						LEFT JOIN Areas a ON a.id = e.area
                    WHERE e.estado = 1 AND e.id_empresa = '" . $_SESSION["id_empresa"] . "'
                    ...
                    ");
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="' . $url . '?pg=estructura/lider/agregar&id=' . $data["id"] . '">
