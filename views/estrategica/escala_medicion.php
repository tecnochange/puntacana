...
$(document).ready(function() {
    ...
    $('#bt_estrategia_escala').addClass('active');
});
</script>
...
if ($_POST["titulo_uno"] != "") {
    ...
    $querySelect = mysqli_query($connect_admin, "SELECT * FROM Escala_Medicion WHERE id_empresa = " . $user_log["id_empresa"] . "");
        ...
        <div class="col-md-12" align="center">
            <div class="card" style="margin-bottom: 15px">
                <div class="card-header" >
                    ...
                    <h3>Escala de Medición para el Progreso y Logro de OKRs</h3><br>
                </div>
                <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table" width="100%" style="font-weight: bold; font-size: 15px;">
                                <tr style="border-style:none !important;font-weight: 700;border-color:transparent !important;">
                                    ...
                                    <td style="width: 16.6%" >
                                    <input type="text" name="titulo_dos" id="titulo_dos" placeholder="Avance Mínimo" class="form-control" value="<?php echo $dataEscala["titulo_dos"];  ?>" required>			
                                    </td>
                                    <td style="width: 16.6%" >
                                ...
                                <tr style="font-size: 13px;">
                                    ...
                                    <td><textarea name="subtitulo_dos" id="subtitulo_dos" cols="30" rows="5" placeholder="Requiere atención especial para asegurar un avance con mejores resultados." class="form-control" required><?php echo $dataEscala["subtitulo_dos"];  ?></textarea></td>
