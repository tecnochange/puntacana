...
$(document).ready(function() {
    ...
    $('#bt_estrategia_ponderacion').addClass('active');
});
</script>
...
if ($_SESSION['role_plataforma'] == 2) {
    if ($_SESSION['area'] > 0) {
        ...
        $queryAreaF = mysqli_query($connect_admin, "SELECT * FROM Areas WHERE id_empresa = '" . $user_log['id_empresa'] . "' AND nombre = '" . $_SESSION['area'] . "' ");
...
$queryEstrategicos = mysqli_query($connect_okrs, "SELECT * FROM Objetivos_estrategicos WHERE id_empresa = " . $user_log["id_empresa"] . " AND anio = " . $_SESSION["anio_fill"] . "");

$cont = 0;
$count_anios = array();
foreach ($Array_Anio as $value) {
    $queryAnio = mysqli_query($connect_okrs, "SELECT * FROM Objetivos_estrategicos WHERE id_empresa = '" . $user_log['id_empresa'] . "' AND anio = " . $value[1] . "");
...
if($_POST["guardar_ponderacion"] != ""){
    $queryOrg = mysqli_query($connect_okrs, "SELECT * FROM Okrs WHERE id_empresa = " . $user_log["id_empresa"] . " AND tipo = 1  AND anio = " . $_SESSION["anio_fill"] . " AND (objetivos_estrategicos LIKE '%," . $_POST["id_registro"] . "' OR objetivos_estrategicos IN (".$_POST["id_registro"].")) $filtro_claves");
	...
	VALUES (" . $user_log["id_empresa"] . ", " . $_SESSION["id_user"] . ",'$accion','$descripcion'," . $data2["tipo"] . "," . $dataResultadosIni["id_okrs"] . "," . $_POST["id_registro"] . "," . $dataResultadosIni["id"] . ",'$hoy')";
		echo $auditoria;
		mysqli_query($connect_okrs, $auditoria);
    }
}

$querySM25 = mysqli_query($connect_admin, "SELECT * FROM Submenu_Empresa WHERE id_empresa = " . $user_log["id_empresa"] . " AND estado = 1 AND id_menu = 2 AND id_submenu = 14");
...
<div class="container">
    ...
    while ($dataEstrategicos = mysqli_fetch_array($queryEstrategicos)) {
        ...
        $sum_resultado1 = 0;
        $queryOrganizacional1 = mysqli_query($connect_okrs, "SELECT * FROM Okrs WHERE id_empresa = " . $user_log["id_empresa"] . " AND tipo = 1 AND anio = " . $_SESSION["anio_fill"] . " AND objetivos_estrategicos LIKE '%" . $dataEstrategicos["id"] . "%' $filtro_claves");
        ...
        while ($dataOrganizacional1 = mysqli_fetch_array($queryOrganizacional1)) {
            ...
            $escala1 = EscalaColor($sum_resultado1, $_SESSION['id_empresa'], $connect_admin);
            $escala2 = EscalaColor(round(($dataEstrategicos["ponderacion"] * $sum_resultado1) / 100, 2), $_SESSION['id_empresa'], $connect_admin);
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card" style="text-align: left;">
                                <div class="card-body">
                                    <h3>OBJETIVO ESTRATÉGICO</h3><br>
                                    <h4><?php echo $dataEstrategicos["objetivo"]; ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="card" style="text-align: center;">
                                <div class="card-body">
                                    ...
                                    <h1><?php echo $dataEstrategicos["ponderacion"]; ?>%</h1>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card" style="text-align: center;">
                                <div class="card-body">
                                    <h3>DESEMPEÑO DE LOS OKR'S</h3><br>
                                    <h1><?php echo $sum_resultado1; ?>%</h1>
                                    <div class="progresos" data-bs-toggle="tooltip" align="center">
                                        <h2 style="font-size: 2.5rem;color: black !important;"><?php echo $sum_resultado1; ?> %</h2>
                                    </div>
                                    <div class="progress-bar bg-success" role="progressbar" style=" width: <?php echo $sum_resultado1;  ?>%;background-color: <?php echo $escala1["color_bg"];    ?> !important;opacity: 0.3;z-index: 2;margin-top: -70px;height: 70px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                    </div> 
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card" style="text-align: center;">
                                <div class="card-body">
                                    ...
                                    <h1 style="color: black !important;"><?php echo round(($dataEstrategicos["ponderacion"] * $sum_resultado1) / 100, 2); ?>%</h1>
                                    <div class="progresos" data-bs-toggle="tooltip" align="center">
                                        <h2 style="font-size: 2.5rem;color: black !important;"><?php echo round(($dataEstrategicos["ponderacion"] * $sum_resultado1) / 100, 2); ?> %</h2>
                                    </div>
                                    <div class="progress-bar bg-success" role="progressbar" style=" width: <?php echo round(($dataEstrategicos["ponderacion"] * $sum_resultado1) / 100, 2); ?>%;background-color: <?php echo $escala2["color_bg"];  ?> !important;opacity: 0.3;z-index: 2;margin-top: -70px;height: 70px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                    </div> 
                                </div>
                            </div>
                        </div> 
                                ...
                                <div class="table-responsive">
                                    <table border="1" class="display table" style="width:100%" id="estrategico_<?php echo $dataEstrategicos["id"]; ?>">
                                        ...
                                        <tbody>
                                            ...
                                            $queryOrganizacional = mysqli_query($connect_okrs, "SELECT * FROM Okrs WHERE id_empresa = " . $user_log["id_empresa"] . " AND tipo = 1  AND anio = " . $_SESSION["anio_fill"] . " AND (objetivos_estrategicos LIKE '%," . $dataEstrategicos["id"] . "' OR objetivos_estrategicos IN (".$dataEstrategicos["id"].")) $filtro_claves");
                                            ...
                                            while ($dataOrganizacional = mysqli_fetch_array($queryOrganizacional)) {
                                                ...
                                                $escala = EscalaColor($a_por, $_SESSION['id_empresa'], $connect_admin);
                                                $color_bg = $escala['color_bg'];
                                                $editar_ponderacion = '<input type="number" name="" class="form-control form-control-sm mb-0" value="' . $dataOrganizacional["ponderacion"] . '" onChange="Guardar_Avance_Ponderacion(this.value, ' . $dataOrganizacional["id"] . ',' . $user_log["id_empresa"] . ',' . $_SESSION["id_user"] . ')" >';
                                                ...
                                                $escala1 = EscalaColor($desmepenioPorc, $_SESSION['id_empresa'], $connect_admin);
                                                $color_bg1 = $escala1['color_bg'];

                                                $escala2 = EscalaColor($a_por5, $_SESSION['id_empresa'], $connect_admin);
