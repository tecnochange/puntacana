...
<div class="card" style="margin-bottom: 15px; font-size: 13px; border-bottom: 3px solid #4286f5;">
    ...
    <table width="100%"><tr>
    	<td width="60" align="left">
			<?php
			if($dataUser["foto"] != ""){
				echo '<div class="miniatura_home" style="background-image:url('.$recursos_clima.'/'.$dataUser["foto"].');"></div>';
			}
			else{
				echo '<img loading="lazy" src="img/1.png" width="50" class="ico_card" /><br />';
			}
			?>
		</td>
        ...
        <td align="right">
			...
			if($data["id_user"] == $_SESSION['id_user']){
				echo '
					...
					<a href="?pg=clima/wandbook/retos&id='.$data["id"].'"><img loading="lazy" src="img/ico_edit.png" width="22" class="ico_edit_opt"/></a>
				';
			}
			?>
        </td>
    ...
    <?php
	$listAcepto = '';
	$queryAceptoList = mysqli_query($connect_clima,"SELECT * FROM Aceptados WHERE id_publicacion = '".$data["id"]."' ORDER BY id DESC LIMIT 10 ");
    ...
    <table style="margin:15px; color: #080808;" width="92%">
        	<tr>
                ...
                <td align="center" width="33%">
                	<a tabindex="<?php echo $tab_index; ?>" role="button" data-toggle="popover" data-trigger="focus" data-content="<?php echo $listAcepto; ?>"><img loading="lazy" src="img/ico_acepto.png" width="30" /></a>
    ...
    <table width="100%" >
		<tr>
			<td align="center" width="33%" class="bt_option_card" onclick="Me_Gusta(<?php echo $data["id"]; ?>)">
				<img loading="lazy" src="img/ico_like_stroke.png" width="40" /> Me gusta
			</td>
			<td align="center" width="33%" class="bt_option_card" onclick="Acepto_Reto(<?php echo $data["id"]; ?>)"><img loading="lazy" src="img/ico_acept_stroke.png" width="40" /> Acepto</td>					
			<td align="center" class="bt_option_card" onclick="Comentar(<?php echo $data["id"]; ?>)"> <img loading="lazy" src="img/ico_comment.png" width="40"/> Comentar</td>
		</tr>
	</table>
