<script>
    ...
    $("#bt_admin_configurar_general").addClass("current-page");
</script>
<style>
    .card,
    .card-header,
...
if ($_POST["guardar_configurar"] != "") {
    mysqli_query($connect_valentina, "UPDATE Empresas SET formato_numerico = '".$_POST["formatoNumerico"]."' , anio_curso = '" . $_POST["anio_curso"] . "', mes_inicio = '" . $_POST["mes_inicio"] . "', mes_fin = '" . $_POST["mes_fin"] . "', update_at = '$hoy'  WHERE id = '" . $_SESSION["id_empresa"] . "'  ");
...
if ($_POST["guardar_nombre_menu"] != "") {
    $queryM = mysqli_query($connect_valentina, "SELECT * FROM Menu_Empresa WHERE id_empresa = " . $_SESSION["id_empresa"] . " $complementoM");
...
if ($_POST["guardar_desempenio"] != "") {
    ...
    $queryNJ = mysqli_query($connect_valentina, "SELECT * FROM Nivel_Jerarquico WHERE id_empresa = '" . $_SESSION["id_empresa"] . "' AND estado = 1 AND nivel NOT IN (1,6)");
...
if ($_POST["guardar_configruar_ciclo"] != "") {
    mysqli_query($connect_valentina, "UPDATE Empresas SET anio_ciclo = '" . $_POST["anio_ciclo"] . "', id_ciclo = '" . $_POST["ciclo"] . "', update_at = '$hoy'  WHERE id = '" . $_SESSION["id_empresa"] . "'  ");
...
$querySM21 = mysqli_query($connect_valentina, "SELECT * FROM Submenu_Empresa WHERE id_empresa = " . $_SESSION["id_empresa"] . " AND estado = 1 AND id_menu = 2 AND id_submenu = 10");
            ...
            <div class="card-header" style="background-color: #FFFFFF !important;padding: .5rem 1rem !important;">
                <div class="row">
                    <div class="col-md-12" style="text-align: start !important;">
                        <h4><i class="fas fa-sitemap" id="iconCabecera"></i>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo $dataSM21["nombre"]; ?></h4>
                    </div>
                </div>
            </div>
        </div>
