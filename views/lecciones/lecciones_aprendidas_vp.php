...
$(document).ready(function() {
    ...
    $('#bt_lecciones_direccion').addClass('active');
});
</script>
...
if ($_SESSION["role_plataforma"] == 1) {
    $resultado = CargaLeccionesAdminVP($connect_clima, $connect_admin, $filtro_la, $filtro_kr, $filtro_claves, $filtro_area, $filtro_vp);
} else if ($_SESSION["role_plataforma"] == 2) {
    $resultado = CargaLeccionesLiderVP($connect_clima, $connect_admin, $filtro_la, $filtro_kr, $filtro_claves, $filtro_area, $filtro_vp, $_SESSION["id_user"]);
} else {
    $resultado = CargaLeccionesColaboradorVP($connect_clima, $connect_admin, $filtro_la, $filtro_kr, $filtro_claves, $filtro_area, $filtro_vp, $_SESSION["id_user"]);
}
...
$querySM73 = mysqli_query($connect_admin, "SELECT * FROM Submenu_Empresa WHERE id_empresa = " . $_SESSION["id_empresa"] . " AND estado = 1 AND id_menu = 7 AND id_submenu = 43");
            ...
            <div class="card-header" style="background-color: #FFFFFF !important;">
                <div class="row">
                    <div class="col-md-12" style="text-align: start !important;">
                        <h3><?php echo $dataSM73["nombre"]; ?></h3>
                    </div>
                </div>
            </div>
        </div>
