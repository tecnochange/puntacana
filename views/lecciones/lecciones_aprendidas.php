...
if ($_POST["area_lA"] == "") {
    $_SESSION["area_lA"] = "";
    $filtro_area .= " AND area IS NOT NULL AND area <> ''";
}
...
<div class="container-fluid">
    <?php include("views/lecciones_aprendidas/detalle/filtros.php"); ?>
    <?php
            ...
            <div class="card">
                <div id="accordionLA" class="accordion-icons" role="tablist">
                    ...
                    if ($_SESSION["role_plataforma"] == 1) {
                        ...
                        $id_vp_unique = array_unique($id_vp_values);
                    ...
                    while ($dataVP = mysqli_fetch_array($queryVP)) {
                        $arrayCol = array();
                        include("views/lecciones_aprendidas/detalle/listado_areas.php");

                        $equipo = array_sort($arrayCol, 'contador', SORT_DESC);
                    ...
                    ?>
                        <div class="card mb-0" style="margin-bottom: 10px !important;">
                            ...
                            <div id="collapseVP_<?php echo $dataVP["id"]; ?>" class="collapse" role="tabpanel" aria-labelledby="heading<?php echo $dataVP["id"]; ?>" data-parent="#accordionLA">
                                <?php include("views/lecciones_aprendidas/detalle/areas_vp.php"); ?>
                            </div>
                        </div>
                    <?php
...
<script>
    ...
    $("#bt_la_lecciones_area").addClass("current-page");
</script>
...
<script>
    ...
    function VerCelula(id, id_user) {
		jQuery.ajax({
				url: api + "ver_celula.php",
				type: 'post',
				data: {
					id: id,
                    id_user: id_user,
                    url_area: "?pg=lecciones_aprendidas/detalle/administrar_participantes&id_area="+id,
				},
			}).done(function(resp) {
				$("#modal_la").modal("show");
