            ...
            if (mysqli_num_rows($queryLideres) > 0) {
                while ($dataLideres = mysqli_fetch_array($queryLideres)) {
                    ...
                    if (!$dataEmple["foto"]) {
                        ...
                        $listado_lideres .= '<a data-bs-toggle="tooltip" href="javascript:Profile(' . $dataLideres["id_lider"] . ',1)" class="dropdown-item" id="profileOkr"><img data-src="https://puntacana.goforagile.com/recursos/' . $dataEmple["foto"] . '" class="lazyload foto_min" title="' . $dataEmple["nombre"] . '" style="width: 35px !important;height: 35px !important;"></a>';
                    }
            } 
            else {
