...
class KpisServicios{
    ...
    public function kpis_area( $id_empresa, $id_area, $id_vicepresidencia ){
        ...
        while ($dataKpis = mysqli_fetch_assoc($queryKpis)) {
            ...
            //UNIDAD DE MEDIDA
            $txt_unidad_medida = "";
            if($dataKpis["unidad_medida"] == 1 ){ 
                $txt_unidad_medida = "Cantidad";
            }
            if($dataKpis["unidad_medida"] == 2 ){ 
                $txt_unidad_medida = "Porcentaje";
            }
            if($dataKpis["unidad_medida"] == 3 ){ 
    ...
    public function kpis_colaborador( $id_empresa, $id_area, $id_vicepresidencia, $id_colaborador ){ 
        ...
        while ($dataKpis = mysqli_fetch_assoc($queryKpis)) {
            ...
            $dataKpis["subproceso_txt"] = $subproceso["unidad_organizativa"]; 
    ...
    public function kpis_empresa( $id_empresa, $id_area, $id_vicepresidencia, $id_colaborador ){
        ...
        while ($dataKpis = mysqli_fetch_assoc($queryKpis)) { 
            ...
            $dataKpis["integrantes"] = $this->obtener_integrantes_v2($id_empresa, $dataKpis["id_kpi"], $responsables);
    ...
    public function obtener_comentarios($id_kpi, $frecuencia){
        ...
        if(mysqli_num_rows($query) > 0){
            ...
            $analisis = '<span class="btn btn-sm btn-danger" style="color:white; font-size:0.6rem; min-width:110px;">
                Pendiente Análisis
            </span>';
            return $analisis;
        }
